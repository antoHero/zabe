<div>
    <form wire:submit.prevent="handleCreate" action="#" method="POST" class="space-y-4 px-4 py-6">
        <div>
            <input
                type="text"
        ...
        <div>
            <select
                ...
                id="category_add"
                class="w-full rounded-xl border-none px-4 py-2 text-sm bg-gray-100"
            >
    ...
    <div>
        @if (session('success_message'))
            <div
                ...
                "
                x-show.transition.duration.5000ms="isVisible"
                class="text-green mt-2 px-2 py-3 w-auto text-center justify-center"
            >
