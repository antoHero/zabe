<x-app-layout>
                ...
                <div class="flex items-center justify-between mt-6">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <button class="relative bg-gray-100 hover:bg-gray-200 border rounded-full h-7 transition duration-150 ease-in py-2 px-3">
                            ...
                            <ul class="hidden absolute w-[11rem] text-left font-semibold bg-white shadow-dialog rounded-xl py-3 ml-8">
    ...
    <div class="comments-container relative space-y-6 ml-[5.5rem] pt-4 my-8 mt-1">
