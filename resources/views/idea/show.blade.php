        ...
        <div class="flex flex-col md:flex-row items-center space-x-4 md:ml-6">
            ...
            >
                ...
                <div
                    ...
                    @click.away="isOpen = false"
                    @keydown.escape.window="isOpen = false"
                    class="absolute z-10 w-64 md:w-[26rem] text-left font-semibold text-sm bg-white shadow-dialog rounded-xl mt-2"
                >
            ...
            >
                ...
                <div
                    ...
                    @click.away="isOpen = false"
                    @keydown.escape.window="isOpen = false"
                    class="absolute z-20 w-[19rem] text-left font-semibold text-sm bg-white shadow-dialog rounded-xl mt-2"
                >
                    <form action="#" class="space-y-4 px-4 py-6">
                        <div class="space-y-2">
                            <div>
